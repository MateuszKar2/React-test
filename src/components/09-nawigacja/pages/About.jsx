...
export const About = () => {
    return (
      ...
      <Outlet/>{/*wskazanie, w którym miejscu, w komponencie Route-rodzica About, chcemy renderować zagnieżdzone Route-dzieci.
       W tym celu wykorzystywany jest komponent Outlet. */}
      </main>
    );
  };